...
def wbc_qp_step(robot_id, dof, end_eff_link, pos_des, q_ddot_min=-100, q_ddot_max=100, alpha=1e-2):
    """
    ...
    x_ddot_des = compute_task_desired_accel(pos_des, pos_cur, vel_cur, kp=500.0, kd=10.0)
